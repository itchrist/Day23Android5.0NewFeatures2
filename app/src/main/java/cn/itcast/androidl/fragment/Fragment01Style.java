 ...
 * 01.主题样式
 */
public class Fragment01Style extends BaseFragment implements MenuItem.OnMenuItemClickListener {
	...
	protected View initView(){
		View view = View.inflate(getActivity(), R.layout.fragment01_style,null);
	...
	protected void reload() {
		...
		getActivity().finish(); // 销毁当前主界面，不显示activity切换时的动画效果。

		FragmentFactory.clear();

		getActivity().overridePendingTransition(0, 0);
		startActivity(intent); // 重新再启动主界面，使用新的主题显示
	}
